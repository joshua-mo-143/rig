...
## [0.7.1](https://github.com/joshua-mo-143/rig/compare/rig-core-v0.7.0...rig-core-v0.7.1) - 2025-02-06
...
- Correct `tracing::debug` message. ([#275](https://github.com/joshua-mo-143/rig/pull/275))
- agent recipes (#215)
- Revert "feat: add Galadriel API integration ([#188](https://github.com/joshua-mo-143/rig/pull/188))" ([#264](https://github.com/joshua-mo-143/rig/pull/264))
- *(example)* fix grammar mistake (#260)
- Fix typos  "substract" → "subtract" ([#256](https://github.com/joshua-mo-143/rig/pull/256))
- fix typos (#242)
